...
const deleteAllTransfer = `-- name: DeleteAllTransfer :exec
DELETE FROM transfers
`

func (q *Queries) DeleteAllTransfer(ctx context.Context) error {
	_, err := q.db.ExecContext(ctx, deleteAllTransfer)
	return err
}
